...
// InviteDeclinePost attempts to accept an invite.
func InviteDeclinePost(opportunitiesService opportunities.Service) http.HandlerFunc {
	type request struct {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = opportunitiesService.DeclineInvite(ctx, opportunityID, userID, inviteID, req.Key)
		if err != nil {
			switch err.(type) {
